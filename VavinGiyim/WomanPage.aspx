<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="WomanPage.aspx.cs" Inherits="VavinGiyim.WomanPage" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server" style="width:100%;" >
      ...
      <a href="Anasayfa2.aspx" style="text-decoration:none; text-decoration-color:black; color:black;"> <label style="font-size:40px; color:black; width:16%; height:44px;">VAVİN</label></a>
             <a href="Favorilerim.aspx" style="text-decoration:none; margin-left:63%;">  <asp:Image ID="Image1" runat="server" Height="42px"   src="/images/Kalp.png" Width="55px"  /></a> 
...
<li>
    ...
    <div style="padding-top:0px; width:100%; height:100%;  background-color:white">
     <asp:Label ID="txterkurun" style=" font-size:45px;" runat="server" Text="Label"> Kadın Haki Kürk Garnili Kaban</asp:Label> <br /><br />
     ...
     <a style="margin-left:70%; margin-bottom:40px;">  <asp:ImageButton ID="Kalp" runat="server" src="/images/Kalp.png"  Width="10%" Height="100px" OnClick="Kalp_Click"  /></a><br /><br />
 <asp:Label ID="txtfiyat" runat="server" Text="Label" Height="20px"  Font-Size="60px"> 121,90</asp:Label>&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="Label" Height="20px"  Font-Size="60px"> TL</asp:Label>

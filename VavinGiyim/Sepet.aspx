<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="Sepet.aspx.cs" Inherits="VavinGiyim.Sepet" %>
...
<li>
    ...
    <input  type="text" name="text"  style="height:250px; width:90%; margin-right:1%;margin-left:2%;"><br /><br />
          <asp:Button ID="Button1" runat="server" Text="SATIN AL" Width="60%" Height="80px" BackColor="YellowGreen" ForeColor="White" OnClick="Button1_Click"></asp:Button>
        </center>
        </div>

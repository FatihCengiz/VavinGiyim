<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="UyeOl.aspx.cs" Inherits="VavinGiyim.UyeOl" %>
    ...
    <asp:Image ID="Kategori"  runat="server" Height="25px"   src="/images/Kategori.png" Width="43px"  /> </a>
     ...
     <h2 style="margin-left:1%;">Üye Ol</h2> <br /><br />
        ...
        <a style="position:absolute; margin-left:1%; margin-top:-30px;"> <asp:Image ID="Ad"    runat="server"   src="/images/Ad.png" Width="100%" Height="70px"   />     </a>
          ...
          <a style=" margin-left:8.8%;">  <asp:textbox ID="txtsoyad" runat="server" Width="80%" Height="40px"></asp:textbox></a>
            <br /> <br /> <br /> 
          ...
          <a style=" margin-left:9%;">  <asp:textbox ID="sifre1" runat="server" Width="80%" Height="40px"></asp:textbox></a>
            <br /> <br /> <br /> 
          ...
          <a style=" margin-left:8.8%;">  <asp:textbox ID="sifre2" runat="server" Width="80%" Height="40px"></asp:textbox></a>
            <br /> <br /> <br /> 
        ...
        <h2> <input type="checkbox" name="chc1" value="value" style="height:35px; width:35px; margin-right:1%;margin-left:2%;"">Kampanyadan e-posta ve sms ile haberdar olmak istiyorum.</h2><br />
             <h2> <input id="chcsozlesme" type="checkbox" name="chc2" value="value" style="height:35px; width:35px; margin-right:1%;margin-left:2%;"">Gizlilik sözleşmesini onaylıyorum.</h2><br />
...
<div class="panel">
  <p></p>
         ...
         <div style="padding-top:2%;  width:100%;  ">
            ...
            <Center>
                    <asp:TextBox ID="TextBox1" AutoCompleteType="Disabled" ForeColor="LightGray" runat="server" TextMode="SingleLine" maxlength="11" value="Aradığınız Ürünü Yazın..." onfocus="if(this.beenchanged!=true){ this.value = ''}" onblur="if(this.beenchanged!=true) { this.value='Aradığınız Ürünü Yazın...' }" onchange="this.beenchanged = true;" Height="50px" Width="65%"></asp:TextBox>

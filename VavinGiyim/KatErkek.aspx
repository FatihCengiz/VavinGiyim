<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="KatErkek.aspx.cs" Inherits="VavinGiyim.KatErkek" %>
<!DOCTYPE html>
     ...
     <ul class="anamenu">
        ...
        <li ><a>Botlar ve Çizmeler</a></li>     
         ...
         <div style=" position:absolute; left:10%; margin-top:-20px; top: 140px; width:80%;  min-width: 30%; height: 27px; right: 97px;"> 
          ...
          <center>    <asp:Image ID="fitre"  runat="server"   src="/images/fitre.png" Width="92%" Height="120px"   /> <br /><br /></center>
         
            
     <center>    <a href="ManPage.aspx">    <asp:Image ID="e1"  runat="server"   src="/images/e1.png" Width="47%" Height="500px"   /> </a> 
                       <a href="ManPage.aspx">  <asp:Image ID="e2"  runat="server"   src="/images/e2.png" Width="47%" Height="500px"   /> </a> 
     </center>
          <br />                                                                    
      <center>        <asp:Image ID="e3"  runat="server"   src="/images/e3.png" Width="47%" Height="500px"   />  
                  <asp:Image ID="e4"  runat="server"   src="/images/e4.png" Width="47%" Height="500px"   />  </center>
          <br />                                                                   
       <center>       <asp:Image ID="e5"  runat="server"   src="/images/e5.png" Width="47%" Height="500px"   /> 
                 <asp:Image ID="e6"  runat="server"   src="/images/e6.png" Width="47%" Height="500px"   /> </center>
          <br />       <br />        <br />                                                                   

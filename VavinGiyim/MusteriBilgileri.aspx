<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="MusteriBilgileri.aspx.cs" Inherits="VavinGiyim.MusteriBilgileri" %>
...
<div class="panel">
  <p></p>
         ...
         <div style="padding-top:2%;  width:100%;  ">
            ...
            <Center>
                    <asp:TextBox ID="TextBox5" AutoCompleteType="Disabled" ForeColor="LightGray" runat="server" TextMode="SingleLine" maxlength="11" value="Aradığınız Ürünü Yazın..." onfocus="if(this.beenchanged!=true){ this.value = ''}" onblur="if(this.beenchanged!=true) { this.value='Aradığınız Ürünü Yazın...' }" onchange="this.beenchanged = true;" Height="50px" Width="65%"></asp:TextBox>

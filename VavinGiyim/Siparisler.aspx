<%@ Page Title="" Language="C#"  AutoEventWireup="true" CodeBehind="Siparisler.aspx.cs" Inherits="VavinGiyim.Siparisler" %>
<!DOCTYPE html>
    ...
    <form id="form1" runat="server" style="width:100%;" >
      <div>
           ...
           <a href="MusteriBilgileri.aspx"><asp:Image ID="MüsteriBilgileri"  runat="server" Height="17px"   src="images/MüsteriBilgileri.png" Width="17px"  /></a>
            &nbsp;&nbsp;&nbsp;
           <a href="Siparisler.aspx"> <asp:Image ID="Siparisler1" runat="server" Height="17px"  src="images/Siparisler.png"  /></a>
               &nbsp;&nbsp;
